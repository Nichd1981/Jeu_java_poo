 ...
 */
public class Chevalier extends GestionDesPersonnages implements Pouvoir {
    ...
    public void attaquer(GestionDesPersonnages gestionDesPersonnages) {
        ...
        System.out.println(getNom() + " attaque " + gestionDesPersonnages.getNom() + " avec une attaque " + typeAttaque + ".");
        ...
        gestionDesPersonnages.recevoirDegats(force);
    }
